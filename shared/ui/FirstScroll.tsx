  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        animate={{ opacity: 1 }}
        transition={{ delay: 2 }}
        className="absolute right-0 w-[1101px]  rounded-xl transform flex justify-around items-center    bottom-[110px] flex-wrap  h-[349px] p-12"
      >
        {skills.map((skill) => {
          return (
            <motion.div
              ...
              className=" font-russo select-none cursor-crosshair text-4xl text-black p-4 rounded-2xl bg-gray-500   text-center"
            >
              {skill}
            </motion.div>
          );
